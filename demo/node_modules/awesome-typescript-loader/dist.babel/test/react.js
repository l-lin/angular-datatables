                    ...
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            config = (0, _utils.createConfig)({
                                entry: (0, _utils.fixturePath)(['react', 'index.tsx'])
                            }, {
                                loaderQuery: {
                                    tsconfigContent: undefined,
                                    tsconfig: (0, _utils.fixturePath)(['react', 'tsconfig.json'])
                                }
                            });
                            _context2.next = 3;
                            return (0, _utils.chroot)((0, _utils.fixturePath)('react'), function () {
                        ...
                        case 3:
                            ...
                            (0, _utils.expect)(stats.compilation.errors[1].toString().indexOf('ModuleNotFoundError: Module not found:')).eq(0);
