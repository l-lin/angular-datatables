...
describe('main test', function () {
    it('should emit declaration files', function () {
        return __awaiter(this, void 0, void 0, regeneratorRuntime.mark(function _callee() {
            var config, loaderQuery, stats, assets;
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            this.timeout(10000);
                            config = {
                                entry: (0, _utils.fixturePath)(['declaration', 'basic.ts'])
                            };
                            loaderQuery = {
                                declaration: true
                            };
                        ...
                        case 5:
                            ...
                            (0, _utils.expect)(assets).to.include('src/test/fixtures/declaration/basic.d.ts');
                            // elided import
                            (0, _utils.expect)(assets).to.include('src/test/fixtures/declaration/iface.d.ts');
