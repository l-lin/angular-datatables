                    ...
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            config = (0, _utils.createConfig)({
                                entry: (0, _utils.fixturePath)(['typeRoots', 'index.ts'])
                            }, {
                                loaderQuery: {
                                    tsconfigContent: undefined,
                                    tsconfig: (0, _utils.fixturePath)(['typeRoots', 'tsconfig.json'])
                                }
                            });
                            _context2.next = 3;
                            return (0, _utils.chroot)((0, _utils.fixturePath)('typeRoots'), function () {
