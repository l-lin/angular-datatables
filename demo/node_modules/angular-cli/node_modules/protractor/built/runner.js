...
var Runner = (function (_super) {
     ...
     */
    Runner.prototype.controlFlow = function () { return webdriver.promise.controlFlow(); };
    /**
    ...
    Runner.prototype.createBrowser = function (plugins) {
        ...
        browser_.getProcessedConfig =
            function () { return webdriver.promise.fulfilled(config); };
        browser_.forkNewDriverInstance =
            function (opt_useSameUrl, opt_copyMockModules) {
                ...
                if (opt_useSameUrl) {
                    browser_.driver.getCurrentUrl().then(function (url) { newBrowser.get(url); });
                }
                return newBrowser;
            };
    ...
    Runner.prototype.run = function () {
        ...
        return this.driverprovider_.setupEnv()
            ...
            if (_this.config_.restartBrowserBetweenTests) {
                var restartDriver = function () { browser_.restart(); };
            ...
            if (_this.driverprovider_.updateJob) {
                return _this.driverprovider_.updateJob({ 'passed': testPassed })
                    .then(function () { return _this.driverprovider_.teardownEnv(); });
            }
            else {
            ...
            .fin(function () { return _this.shutdown_(); });
    };
    return Runner;
