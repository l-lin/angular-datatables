/**
 * @license AngularJS v1.3.0-build.2568+sha.dbe381f
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-build.2568+sha.dbe381f/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-build.2568+sha.dbe381f',    // all of these placeholder strings will be replaced by grunt's
